...
silent only
cd ~/Dropbox/a_code/bayesnet
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +168 src/search.c
badd +49 ./src/library.c
badd +108 src/score.c
badd +0 src/main.c
args src/search.c
edit src/main.c
...
exe 'vert 1resize ' . ((&columns * 28 + 117) / 235)
exe 'vert 2resize ' . ((&columns * 42 + 117) / 235)
exe 'vert 3resize ' . ((&columns * 132 + 117) / 235)
exe 'vert 4resize ' . ((&columns * 30 + 117) / 235)
argglobal
enew
file NERD_tree_1
setlocal keymap=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 124 - ((21 * winheight(0) + 28) / 56)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 215 - ((55 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
215
